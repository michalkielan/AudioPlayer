...
void PcmInterface::setParams(snd_pcm_format_t format, snd_pcm_access_t access, Channels channels,
...
snd_pcm_sframes_t PcmInterface::writeInterleaved(const void* buffer, snd_pcm_uframes_t size)
{
...
snd_pcm_sframes_t PcmInterface::writeNonInterleaved(void* buffer, snd_pcm_uframes_t size)
{
...
{
	//std::call_once(chooseWriteFunction, [this](){ this->functionChooser(); });
